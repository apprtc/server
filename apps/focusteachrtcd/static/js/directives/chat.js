...
define(['jquery', 'underscore', 'text!partials/chat.html', 'text!partials/chatroom.html'], function ($, _, templateChat, templateChatroom) {
	...
	return ["$compile", "safeDisplayName", "mediaStream", "safeApply", "translation", "playSound", "fileUpload", "randomGen", "buddyData", "appData", "$timeout",
		function ($compile, safeDisplayName, mediaStream, safeApply, translation, playSound, fileUpload, randomGen, buddyData, appData, $timeout) {
